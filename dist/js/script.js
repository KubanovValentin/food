...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const tabs = document.querySelectorAll('.tabheader__item'),
        ...
        tabsParent = document.querySelector('.tabheader__items'); //1 задача 
  ...
  function showTabContent(i = 0) {
    // (i = 0) - это стандарт по умолчанию 
    // tabsContent[i].style.display = 'block';
    tabsContent[i].classList.add('show', 'fade'); //добавление классов со свойсвами
  ...
  class MenuCard {
    ...
    changeToUAH() {
      this.priice = +this.priice * this.transfer;
    }
